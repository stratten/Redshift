# New file: `RedShiftMobile/RedShiftMobileTests/AudioSpectrumAnalyzerTests.swift`

Follows the existing test style in this target (e.g. `TrackOrderingTests.swift`): plain `XCTestCase`, `@testable import RedShiftMobile`, synthetic fixtures, no real audio files or simulator I/O required.
